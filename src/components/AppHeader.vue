 ...
 <header>
    <div class="d-flex justify-content-between pt-3 p-5">
      ...
      <div class="input-group mb-3 w-25">
        <input @keyup.enter="store.fetchDataMovie(); store.fetchDataSeries()" type="text" class="form-control" placeholder="Type a movie title" aria-describedby="button-addon2"
          v-model="store.query">
